...
echo "=========================================="
echo ""
echo "1. 🌐 打开测试页面（应该已自动打开）"
echo "   URL: file:///Users/hongruiyi/Desktop/mec-v3/ETH-PharmaChain-2-main/frontend/test-web3-contract.html"
echo ""
echo "2. 🔗 点击 '测试 Web3 连接' 按钮"
...
echo "📱 快速链接:"
echo "=========================================="
echo "测试页面: file://$PWD/frontend/test-web3-contract.html"
